...
var BASS_MusicSetVolume:function(handle: HMUSIC; chanins,volume: DWORD): BOOL; stdcall;
var BASS_MusicGetVolume:function(handle: HMUSIC; chanins: DWORD): Integer; stdcall;
...
var BASS_RecordStart:function(freq,flags:DWORD; proc:RECORDPROC; user:DWORD):HRECORD;stdcall;
...
begin
  if BASS_Handle<>0 then result:=true {is it already there ?}
    ...
    BASS_Handle:=LoadLibrary(pchar(dllfilename)); // obtain the handle we want
...
@BASS_MusicSetVolume:=GetProcAddress(BASS_Handle,pchar('BASS_MusicSetVolume'));
@BASS_MusicGetVolume:=GetProcAddress(BASS_Handle,pchar('BASS_MusicGetVolume'));
...
@BASS_StreamGetTags:=GetProcAddress(BASS_Handle,pchar('BASS_StreamGetTags'));
...
(@BASS_MusicGetName=nil)  or
(@BASS_MusicGetLength=nil)  or
(@BASS_MusicPreBuf=nil)  or
(@BASS_MusicPlay=nil)  or
(@BASS_MusicPlayEx=nil)  or
(@BASS_MusicSetAmplify=nil)  or
(@BASS_MusicSetPanSep=nil)  or
(@BASS_MusicSetPositionScaler=nil)  or
(@BASS_MusicSetVolume=nil)  or
(@BASS_MusicGetVolume=nil)  or
...
(@BASS_SamplePlay=nil)  or
(@BASS_SamplePlayEx=nil)  or
(@BASS_SamplePlay3D=nil)  or
(@BASS_SamplePlay3DEx=nil)  or
...
(@BASS_StreamGetLength=nil)  or
(@BASS_StreamGetTags=nil)  or
(@BASS_StreamPreBuf=nil)  or
(@BASS_StreamPlay=nil)  or
