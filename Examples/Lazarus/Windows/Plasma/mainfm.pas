unit MainFm;
//---------------------------------------------------------------------------
// Plasma rendering example.                            Modified: 26-May-2013
// Shows how to use dynamic textures.                            Version 1.02
//---------------------------------------------------------------------------
...
type
  ...
  private
    ...
    SinTab, CosTab: packed array[0..1023] of Word;
    PaletteTab: packed array[0..1023] of LongWord;
    ...
    procedure DoPlasma(ShiftX, ShiftY: Integer);
...
//---------------------------------------------------------------------------
procedure TMainForm.DoPlasma(ShiftX, ShiftY: Integer);
var
...
begin
 for j:= 0 to 255 do
  begin
   ...
   Xadd:= SinTab[((j shl 2) + ShiftX) and $3FF];
   Cadd:= CosTab[((j shl 2) + ShiftY) and $3FF];
