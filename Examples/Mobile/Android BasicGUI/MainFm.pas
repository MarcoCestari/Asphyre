...
uses
  ...
  FMX.Types3D, FMX.Controls, FMX.Forms3D, FMX.Forms, FMX.Platform, FMX.Dialogs;
...
uses
 ...
 IOUtils, Asphyre.Providers.GLES;
...
begin
 ...
 fontTahoma:= GameFonts.Insert(MediaFile.FileName + ' | Tahoma.xml', 'Tahoma.image');
