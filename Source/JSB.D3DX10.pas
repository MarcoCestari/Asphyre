...
uses
  Windows, SysUtils, {$IFDEF UseJSBErrors} UDirectXErrors, {$ENDIF} JSB.DXTypes, JSB.DXGI, JSB.D3DCommon, JSB.D3D10, JSB.D3D10_1;
...
type
  ...
  D3DXCOLOR=D3DCOLORVALUE; // JSB.DXTypes
